...
m1 <- glmer(cbind(snowice_group_raw, dictsize_data - snowice_group_raw) ~ minmonth_tmp + (1|langfamily) + (1|langfamily:glottocode), data = d, family = binomial, control=glmerControl(optimizer="bobyqa")) 
...
m2 <- glmer(cbind(snowice_group_raw, dictsize_data - snowice_group_raw) ~ (1|langfamily) + (1|langfamily:glottocode), data = d, family = binomial, control=glmerControl(optimizer="bobyqa")) 
